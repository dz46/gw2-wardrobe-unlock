...
var acquisitionMethods = [
    ...
    { id: "achievement", name: "Achievement Reward", category: "General"},
    { id: "achievementpoint", name: "Achievement Points Reward", category: "General"},
    ...
    //{ id: "heropoint", name: "Hero Points Reward", category: "General"},
    ...
    //{ id: "birthday2", name: "Second Birthday Gift", category: "General - Anniversary"},
    { id: "birthday3", name: "Third Birthday Gift", category: "General - Anniversary"},
    { id: "birthday4", name: "Fourth Birthday Gift", category: "General - Anniversary"},
    { id: "birthday5", name: "Fifth Birthday Gift", category: "General - Anniversary"},
    { id: "birthday6", name: "Sixth Birthday Gift", category: "General - Anniversary"},
    { id: "birthday7", name: "Seventh Birthday Gift", category: "General - Anniversary"},
    ...
    { id: "gold", name: "Coin", category: "Common", hideOnIcon: true},
    ...
    { id: "researchnote", name: "Research Note", category: "Common"},
    { id: "ancientcoin", name: "Ancient Coin", category: "Common"},
    { id: "unusualcoin", name: "Unusual Coin", category: "Common"},
    ...
    { id: "taleofdungeondelving", name: "Tale of Dungeon Delving", category: "Core / Season 1 / Season 2"},
    ...
    { id: "spoolofsilkthread", name: "Spool of Silk Thread", category: "End of Dragons"},
    { id: "spiritwoodplank", name: "Spiritwood Plank", category: "End of Dragons"},
    { id: "mithrilband", name: "Mithril Band", category: "End of Dragons"},

    { id: "fragmentofprismaticpersuasion", name: "Fragment of Prismatic Persuasion", category: "End of Dragons - Facet of Aurene"},
    { id: "fragmentofprismaticfury", name: "Fragment of Prismatic Fury", category: "End of Dragons - Facet of Aurene"},
    { id: "fragmentofprismaticplant", name: "Fragment of Prismatic Plant", category: "End of Dragons - Facet of Aurene"},
    { id: "fragmentofprismaticfire", name: "Fragment of Prismatic Fire", category: "End of Dragons - Facet of Aurene"},
    ...
    { id: "giftofblood", name: "Gift of Blood", category: "Secrets of the Obscure"},
    { id: "giftofbones", name: "Gift of Bones", category: "Secrets of the Obscure"},
    { id: "giftofclaws", name: "Gift of Claws", category: "Secrets of the Obscure"},
    { id: "giftofdust", name: "Gift of Dust", category: "Secrets of the Obscure"},
    { id: "giftoffangs", name: "Gift of Fangs", category: "Secrets of the Obscure"},
    { id: "giftofscales", name: "Gift of Scales", category: "Secrets of the Obscure"},
    { id: "giftoftotems", name: "Gift of Totems", category: "Secrets of the Obscure"},
    { id: "giftofvenom", name: "Gift of Venom", category: "Secrets of the Obscure"},
    ...
    //{ id: "pvprewardtrack", name: "PvP Reward Track", category: "Competitive"},
    //{ id: "pvpleague", name: "PvP League Reward", category: "Competitive"},
    { id: "pvpleagueticket", name: "PvP League Ticket", category: "Competitive"},
    { id: "shardofglory", name: "Shard of Glory", category: "Competitive"},
    { id: "ascendedshardofglory", name: "Ascended Shard of Glory", category: "Competitive"},
    { id: "pvptournament", name: "PvP Tournament Reward", category: "Competitive"},
    { id: "pvptournamentvoucher", name: "PvP Tournament Voucher", category: "Competitive"},
    //{ id: "wvwrewardtrack", name: "WvW Reward Track", category: "Competitive"},
    { id: "boh", name: "Badge of Honor", category: "Competitive"},
    //{ id: "wvwskirmish", name: "WvW Skirmish Reward", category: "Competitive"},
    ...
    { id: "exoticluck", name: "Essence of Luck (Exotic)", category: "Special Event"},
    { id: "legendaryluck", name: "Essence of Luck (Legendary)", category: "Special Event"},
    { id: "bauble", name: "Bauble Bubble", category: "Special Event"},
    { id: "crimsonassassintoken", name: "Crimson Assassin Token", category: "Special Event"},
    { id: "jorbreaker", name: "Jorbreaker", category: "Special Event"},
    { id: "festivaltoken", name: "Festival Token", category: "Special Event"},
    { id: "favorofthefestival", name: "Favor of the Festival", category: "Special Event"},
    { id: "bundleofloot", name: "Bundle of Loot", category: "Special Event"},
    { id: "candycorncob", name: "Candy Corn Cob", category: "Special Event"},
    { id: "almondsinbulk", name: "Almonds In Bulk", category: "Special Event"},
    { id: "cherriesinbulk", name: "Cherries In Bulk", category: "Special Event"},
    { id: "peachesinbulk", name: "Peaches In Bulk", category: "Special Event"},
    { id: "pinenutsinbulk", name: "Pinenuts In Bulk", category: "Special Event"},
    { id: "pouchofblackpigment", name: "Pouch of Black Pigment", category: "Special Event"},
    ...
    { id: "hallofmonuments", name: "Hall of Monuments Reward", category: "Special Event"},
